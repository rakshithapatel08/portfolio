  ...
  return (
    <div className='w-full h-48 bg-white mt-5 pt-5 pb-5 shadow-md shadow-white'>
        <div className='flex justify-between ml-40 mr-40'>
            <div>
            <p className='pl-4 pr-4 pt-1 text-black text-lg font-bold'>RP.</p>
            ...
            <Link href="mailto:rakshithapatel0807@gmail.com"><div className='flex gap-2 pl-4 pr-4 items-center justify-start mt-2'><Image src="/email.png" width={20} height={20}/><span className='text-black'>rakshithapatel0807@gmail.com</span></div></Link>
            </div>
            ...
            <Link href="https://www.linkedin.com/in/rakshitha-patel-41554523b/"><div className='flex gap-2 mb-1 items-center justify-center'><Image src="/linkedinDark.png" width={30} height={30}/><span className='text-black'>/rakshitha-patel-41554523b</span></div></Link>
                ...
                <Link href="https://rakshithapatel.vercel.app"><div className='flex gap-2 mb-1 items-center justify-center'><Image src="/web.png" width={30} height={30}/><span className='text-black'>/rakshithapatel.vercel.app</span></div></Link>
